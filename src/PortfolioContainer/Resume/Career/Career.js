          ...
          <div className="options-buttons">
            <ul>
              <li>
                <Link
                  to="career-education"
                  containerId="career-info"
                  spy={true}
                  smooth={true}
                  offset={-15}
                  duration={500}
                >
                  <div className="career-btn">Education</div>
                </Link>
              </li>
              <li>
                <Link
                  ...
                  duration={500}
                >
                  <div className="career-btn">Work Experience</div>
                </Link>
              </li>
              <li>
                <Link
                  ...
                  duration={500}
                >
                  <div className="career-btn">Skills</div>
                </Link>
              </li>
              <li>
                <Link
                  ...
                  duration={500}
                >
                  <div className="career-btn">Projects</div>
                </Link>
              </li>
              <li>
                <Link
                  ...
                  duration={500}
                >
                  <div className="career-btn">Interests</div>
                </Link>
              </li>
            </ul>
          </div>
        </div>
        <div className="career-info" id="career-info">
          <div className="career-info-education" id="career-education">
            <div className="responsive-header">Education</div>
            <ul>
              <li>University of Technology, Sydney</li>
            </ul>
            <p>Bachelor of Computing Science &#40;Honours&#41;</p>
            <h3>Current Grade: 77.00 WAM</h3>
            <ul>
              <li>Rouse Hill High School</li>
            </ul>
            <p>Higher School Certificate</p>
          </div>
          <div className="career-info-work" id="career-work">
          <div className="responsive-header">Work Experience</div>
            <ul>
              <li>Australian Electoral Commission</li>
            </ul>
            <p>Polling Assistant</p>
            <ul>
              <li>North Parramatta McDonalds</li>
            </ul>
            <p>Crew Member</p>
          </div>
          <div className="career-info-skills" id="career-skills">
            <div className="career-skills-left">
            <div className="responsive-header">Skills</div>
              <ul>
                <li>JavaScript</li>
              </ul>
            ...
            <div className="career-skills-right">
              <ul>
                <li>Java</li>
              </ul>
              <div className="progress-bar-bg">
          ...
          <div className="career-info-projects" id="career-projects">
          <div className="responsive-header">Projects</div>
            <ul>
              <li>Personal Portfolio Website</li>
            </ul>
            <p>Tools Utilised: ReactJS, Bootstrap</p>
            <ul>
              <li>hearthstone-web</li>
            </ul>
            <p>Tools Utilised: Vanilla JavaScript</p>
            <ul>
              <li>Exam Generator</li>
            </ul>
            <p>Tools Utilised: MathJax, JavaScript</p>
          </div>
          <div className="career-info-interests" id="career-interests">
          <div className="responsive-header">Interests</div>
            <ul>
              <li>Studying Japanese</li>
            </ul>
            <h3>
              Apart from learning new programming languages I also have a deep
              passion in studying spoken languages.
            </h3>
            <ul>
              <li>Tennis</li>
            </ul>
            <h3>
              Occasionally I like to get outside to keep myself healthy and fit,
              especially after long hours at the desk.
            </h3>
            <ul>
              <li>Weightlifting</li>
            </ul>
            <h3>
              I enjoy lifting weights as I find it as an excellent stress
              reliever that I can get my hands on every now and then.
            </h3>
          </div>
        </div>
      </div>
